import { Database, Table, Document } from './database';
...
export declare function flushDatabaseB(connection: Connection, db: Database): Promise<{}>;
export interface FlushOptions {
    afterBegin?: (c: Connection) => Promise<any>;
    beforeCommit?: (c: Connection) => Promise<any>;
    replaceRecordsIn?: string[];
}
export declare function flushDatabase(connection: Connection, db: Database, options?: FlushOptions): Promise<{}>;
