...
function printSchema(schema, keyword = 'interface') {
    ...
    for (const model of schema.models) {
        ...
        for (const field of model.fields) {
            ...
            let flag = '';
            if (field instanceof model_1.SimpleField && !field.column.nullable) {
                flag = '?';
            }
